...
namespace LengthTests
{
    ...
    public class LengthTests
    {
        ...
        {
            Length result = new Length(2, Feet).As(Feet);
        ...
        {
            Length result = new Length(1, Feet).As(Inch);
        ...
        {
            Length result = new Length(3, Feet).As(Yard);
        ...
        {
            Length result = new Length(1, Yard).As(Feet);
        ...
        {
            Length result = new Length(12, Inch).As(Feet);
